...
穿越数据线的注释，应是连续的线段
-->
<!--地图名是readymap.org，地心坐标系，默认版本2-->
<map name="readymap.org" type="geocentric" version="2">

    <!--底层影像名为ReadyMap.org - Imagery，驱动器为tms
    影像信息：A collection of satellite imagery. Blue Marble ocean, 15m Landsat globally and various high resolution insets.
    卫星影像集合，内插有Blue Marble海洋，全球15m Landsat和多分辨率。
    -->
